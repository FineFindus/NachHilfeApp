...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "onboarding_textfield_label_contact" : MessageLookupByLibrary.simpleMessage("Wie soll man dich kontaktieren"),
    "onboarding_textfield_label_name" : MessageLookupByLibrary.simpleMessage("Name"),
    "onboaring_title" : MessageLookupByLibrary.simpleMessage("Bitte gebe deinem Namen an und wie man dich kontaktieren soll (z.B. eine Email-Addresse)."),
    "onborading_textfield_error_contact_empty" : MessageLookupByLibrary.simpleMessage("Bitte trage ein wie man dich kontaktieren soll"),
    "onborading_textfield_error_name_empty" : MessageLookupByLibrary.simpleMessage("Bitte trage einen Namen ein"),
    "onborading_textfield_error_name_numbers" : MessageLookupByLibrary.simpleMessage("Ein Name kann nur Buchstaben enthalten"),
